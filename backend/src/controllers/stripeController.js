...
const createCheckoutSession = async (req, res) => {
  try {
    ...
    const sessionData = {
      ...
      mode: checkoutMode,
      success_url: req.body.successUrl || returnUrl || `https://app.brandout.ai/settings/billing?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: req.body.cancelUrl || `https://app.brandout.ai/settings/billing?canceled=true`,
